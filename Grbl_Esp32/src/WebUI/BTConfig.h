...
#else
namespace WebUI {
    // ESP32-S3 doesn't support Classic Bluetooth - provide stub
    class BluetoothSerial_Stub {
    public:
        bool hasClient() { return false; }
        int read() { return -1; }
        size_t print(const char* text) { return 0; }
        int available() { return 0; }
    };
    
    extern BluetoothSerial_Stub SerialBT;

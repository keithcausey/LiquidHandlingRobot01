...
#if !defined(CONFIG_IDF_TARGET_ESP32S3) && !defined(DISABLE_BLUETOOTH) && defined(ENABLE_BLUETOOTH)
...
#else
    BluetoothSerial_Stub SerialBT;  // Stub for ESP32-S3
#endif
}
...
namespace WebUI {
    ...
    bool BTConfig::isBTnameValid(const char* hostname) { return false; }
    const char* BTConfig::device_address() { return ""; }
    void BTConfig::begin() {}
    void BTConfig::end() {}
    void BTConfig::handle() {}
    void BTConfig::reset_settings() {}

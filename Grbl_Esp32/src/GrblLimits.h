...
/*
  GrblLimits.h - code pertaining to limit-switches and performing the homing cycle
  Part of Grbl
...
typedef uint8_t AxisMask;  // Forward declaration
...
// Internal factor used by limitsCheckSoft

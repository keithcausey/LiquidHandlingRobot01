...
// ESP32-S3 has different RMT register structure - disable RMT for ESP32-S3
...
//#define ENABLE_SSDP                //enable UPNP discovery (commented out - optional library not installed)
